...
static NSString *CellID = @"PhotoBrowserCellID";
...
- (void)startShowAnimation
{
    ...
    NSString *imagePath = [self.delegate photoBrowser:self imageUrlForIndex:self.selectedIndex];
    if ([imagePath rangeOfString:@"http"].location == NSNotFound) {
        animationView.image = [UIImage imageNamed:imagePath];
    }else{
...
- (void)showWithViewController:(UIViewController *)viewController
{
    ...
    else if (self.animationType == AnimationTypePush){
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imagePath = [self.delegate photoBrowser:self imageUrlForIndex:indexPath.item];
...
- (UICollectionView *)collectionView
{
    if (_collectionView == nil) {
        ...
        if (self.cellClass) {
            NSAssert([self.cellClass isSubclassOfClass:[PhotoCell class]], @"自定义cell必须继承LNPhotoCell");
